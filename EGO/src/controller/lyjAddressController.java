...
import dao.lyjAddressDao;
import pojo.lyjAddress;
import service.lyjAddressService;
...
public class lyjAddressController {
	...
	@RequestMapping("/setDefaultAddress1")
	@ResponseBody
	public Map<String, Object> setDefaultAddress1(@RequestBody lyjAddress address) {
		Map<String, Object> data = new HashMap<String, Object>();
		addressService.setDefaultAddress04(address);
		data.put("code","200");
		return data;
	}
}
